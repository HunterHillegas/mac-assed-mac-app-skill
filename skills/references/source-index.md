...
This is a map of the self-contained derived guidance bundled with the skill. It does not require the original source documents and does not include redistributed source text.
...
- OS X environment expectations: menu bar, windows, preferences, help, accessibility, internationalization, typography, bundles, gestures, pointer input, keyboard input.
- Fundamental principles: metaphor, mental model, explicit and implied actions, direct manipulation, see-and-point interaction, user control, feedback, consistency, forgiveness, perceived stability, aesthetic integrity.
- User experience: avoid app-management chores, focus on user solutions, use modelessness where useful, keep apps easy to learn, support full screen where appropriate, respond quickly, provide alternate paths, use standard elements correctly, make exploration safe, earn trust, adapt to environment changes, use user-centric terminology, brand appropriately, provide shortcuts.
- Technology surfaces: Dock, Finder, Notification Center, sharing, contacts/calendars/reminders when relevant, colors/fonts panels, printing, preferences/settings, services, speech, drag and drop, autosave/versions, Spotlight, Help.
